...
public class wrongAnimal extends AppCompatActivity {
    ...
    public void onNextButtonClick(View view) {
        ...
        Intent intent = new Intent(wrongAnimal.this, main_menu.class);
        startActivity(intent);
    }

    public void onTryButtonClick(View view) {
        // Создаем интент для перехода на следующую активность
        Intent intent = new Intent(wrongAnimal.this, animal.class);
        startActivity(intent);
    }
}